const Card = ({ photo, price, name,  summary, id, marca, openFullCard }) => {
  return (
    <div className="max-w-[280px] 2xl:min-h-[450px] xl:max-h-[300px] xl:min-h-[300px] 2xl:max-h-[450px] bg-sky-200 px-4 pt-2 pb-1 rounded-xl shadow-lg transform hover:scale-105 transition duration-500 my-4 border-dashed relative">
      <h1 className="mt-4 text-gray-800 2xl:text-2xl font-bold cursor-pointer text-md">{marca}</h1>

      <div className="relative">
        <img className="rounded-xl xl:h-[100px] xl:w-[130px]" src={photo} alt="Colors" />
