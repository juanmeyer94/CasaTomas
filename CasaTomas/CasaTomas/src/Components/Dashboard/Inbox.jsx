...
const Inbox = () => {
    return (
        <div className="xl:pl-64">
            <h1 className="text-center text-6xl bg-blue-300 font-mono -mb-4 text-gray-800 dark:text-white">Pedidos</h1>
<div class="sm:px-6 w-full">

            <div class="px-4 md:px-10 py-2 md:py-7">
                <div class="flex items-center justify-between">
                    <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-sky-800">CASA TOMAS</p>
